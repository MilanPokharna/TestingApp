...
public class Gaurav extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //  progressDialog.show();
        View rootView = inflater.inflate(R.layout.fragment_gaurav, container, false);
        cardView = (CardView) rootView.findViewById(R.id.gaurav);
    ...
    @OnClick(R.id.linkdin_prog)
    public void onViewClicked() {
        Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.linkedin.com/in/gaurav2621998/"));
